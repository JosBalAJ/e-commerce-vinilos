...
<head>
    ...
    <title>Bitácora Discos - Vinilos Josue</title>
...
<body>
    <header>
        ...
        <h1>Bitácora de Discos</h1>
        <img class="logo" src="img/Vinilo Logo.jpg" alt="Vinilo Logo">
    </header>
    <main>
        <h1>Historial de Acciones en Discos</h1>
        <div class="tabla">
            <div class="columna1 columnas">
                <?php
                $sql = "SELECT * FROM bitacora_discos";
                ...
                foreach ($registros as $fila) {
                    echo '<div class="fila bold">
                            <span>' . $fila['id_cambio_disco'] . '</span>
                        </div>';
                }
                ?>
            </div>
            ...
            <div class="columna3 columnas">
                ...
                foreach ($registros as $fila) {
                    echo '<div class="fila bold">
                            <span>' . $fila['fecha_cambio_disco'] . '</span>
                        </div>';
                }
                ?>
            </div>
            ...
            <div class="columna5 columnas">
                ...
                foreach ($registros as $fila) {
                    echo '<div class="fila largos">
                            <span>' . $fila['sentencia_disco'] . '</span>
                        </div>';
                }
                ?>
            </div>
            <div class="columna6 columnas">
                ...
                foreach ($registros as $fila) {
                    echo '<div class="fila largos">
                            <span>' . $fila['contrasentencia_disco'] . '</span>
                        </div>';
                }
                ?>
            </div>
